...
/// resource
resource "azurerm_policy_definition" "aum_policy_schedule_updates_using_update_manager" {
  name         = "${var.deploymentEnvironment}-aum-policy-schedule_updates_using_update_manager"
...
/// output
output "aum_policy_schedule_updates_using_update_manager_policy_definition_id" {
  value = azurerm_policy_definition.aum_policy_schedule_updates_using_update_manager.id
}
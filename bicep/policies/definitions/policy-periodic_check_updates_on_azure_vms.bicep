...
/// variables
var name = toLower('${environment}-aum-policy-periodic_check_updates_on_azure_vms')

/// resources
resource aum_policy_periodic_check_updates_on_azure_vms 'Microsoft.Authorization/policyDefinitions@2023-04-01' = {
  name: name
  properties: {
...
/// outputs
output policyDefinitionId string = aum_policy_periodic_check_updates_on_azure_vms.id

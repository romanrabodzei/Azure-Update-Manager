...
/// variables
var name = toLower('${environment}-aum-policy-set_prereq_for_updates_on_azure_vms')

/// resources
resource aum_policy_set_prereq_for_updates_on_azure_vms 'Microsoft.Authorization/policyDefinitions@2023-04-01' = {
  name: name
  properties: {
    displayName: 'Set prerequisite for Scheduling recurring updates on Azure virtual machines.'
...
/// outputs
output policyDefinitionId string = aum_policy_set_prereq_for_updates_on_azure_vms.id

...
/// variables
var name = toLower('${environment}-aum-policy-vms_should_check_for_missing_updates')

/// resources
resource aum_policy_vms_should_check_for_missing_updates 'Microsoft.Authorization/policyDefinitions@2023-04-01' = {
  name: name
  properties: {
...
/// output
output policyDefinitionId string = aum_policy_vms_should_check_for_missing_updates.id
